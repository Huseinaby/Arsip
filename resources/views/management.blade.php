...
@section('container')
    ...
    <script>
        ...
        function openEditModal(item) {
            ...
            // document.getElementById('multiple_files').value = item.imbs;
        ...
        function printTable() {
            ...
            printWindow.onload = function() {
                ...
                setTimeout(() => {
                    ...
                    "{{ route('management') }}"; // Kembali ke halaman management setelah cetak
                }, 1000); // menunggu 5 detik (5000 ms) sebelum kembali
            };
        }
