    ...
    <div class="flex">
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200 max-h-60 overflow-auto"
                ...
                <!-- Dropdown Items -->
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="No Dp">No Dp</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Nama">Nama</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Alamat">Alamat</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Lokasi">Lokasi</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Kategori">Kategori</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Box">Box</button>
                </li>
                <li>
                    <button type="button" class="filter-item inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" data-filter="Tahun">Tahun</button>
                </li>
            </ul>
        </div>
