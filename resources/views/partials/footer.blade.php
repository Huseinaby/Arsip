        ...
        <div class="md:flex md:justify-between">
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://github.com/Huseinaby/Arsip/tree/main" class="hover:underline ">Github</a>
                      </li>
              ...
              <div>
                  ...
                  <ul class="text-gray-500 dark:text-gray-400 font-medium">
                      <li class="mb-4">
                          <a href="https://dispersip.banjarmasinkota.go.id/" class="hover:underline">Privacy Policy</a>
                      </li>
